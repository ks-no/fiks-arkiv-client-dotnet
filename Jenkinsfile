pipeline {
    ...
    parameters {
      ...
      booleanParam(name: 'signDllFiles', defaultValue: false, description: 'Skal dll-fil signeres vha signtool.exe? Krever at det er en SignAssembly-target i csproj-fil')
